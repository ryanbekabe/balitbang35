...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_EDITABLE_VALID_EXTS', 'txt,htm,html'); //make you include all these extension in CONFIG_UPLOAD_VALID_EXTS if you want all valid
	
	define('CONFIG_OVERWRITTEN', false); //overwirte when processing paste
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,bmp,txt,jpg,png,zip,rar,doc,ppt,pdf,docx,xls,pptx,xlsx,pptx,tif,mp3,wav,wmv,wma,rm,rmvb,mov,swf'); // 
	...
	define("CONFIG_VIEWABLE_VALID_EXTS", 'gif,bmp,txt,jpg,png,zip,rar,doc,ppt,docx,xls,pptx,xlsx,pptx,tif,css,dtd,mp3,wav,wmv,wma,rm,rmvb,mov,swf');
	//define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt'); // 
	define('CONFIG_UPLOAD_INVALID_EXTS', 'htm,php,asp,js,html');
